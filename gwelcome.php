...
<div class="container">
        ...
        <button id="explorebutton" onclick="location.href='attendance.php'">Explore</button>
        </div>
        ...
        <button id="explorebutton" onclick="location.href='records.php'">Explore</button>
        </div>
        <div class="box"> <p>Provides transparent payment records for guardians, fostering trust and accountability.</p>
        <h1>Payment Record</h1>
        <button id="explorebutton" onclick="location.href='payment.php'">Explore</button>
        </div>
    </div>
</body>
</html>